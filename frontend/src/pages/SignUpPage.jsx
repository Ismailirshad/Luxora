...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
      <motion.div
        className='sm:mx-auto sm:w-full sm:max-w-md mb-1'
      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
               ...
               <div className="rounded-md bg-gray-900/60 border border-gray-700 p-1">
                <p className="text-xs font-medium text-gray-300">Password must contain:</p>
                <p className="text-xs text-gray-400">1 UpperCase 1 LowerCase 1 Number 1 Special Character</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="password" id='confirmPassword' value={formData.confirmPassword} onChange={(e) => setFormData({ ...formData, confirmPassword: e.target.value })}
                  className='block w-full px-3 py-2 pl-10 bg-gray-700 border-gray-600 rounded-md shadow-sm
                placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm '
          ...
          <p className="mt-8 text-center text-sm text-gray-400">Already have an account?{" "}
