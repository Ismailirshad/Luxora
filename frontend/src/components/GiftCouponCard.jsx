    ...
    return (
        <motion.div
            ...
            <div className="space-y-4">
                <div>
                    <label htmlFor="voucher" className='mb-2 block text-sm font-medium text-gray-300'>Do you have an voucher or gift card?</label>
            ...
            {isCouponApplied && coupon && (
                <div className="mt-4">
                    ...
                    <motion.button
                        type='button'
                        className=' mt-2 flex w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5
            text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 
            focus:ring-red-300'
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
