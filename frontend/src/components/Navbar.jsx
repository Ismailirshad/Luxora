    ...
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800">
      <div className="container mx-auto px-4 py-3">
        <div className="flex  flex-wrap justify-between items-center">
          ...
          >
            <span className="font-light hover:font-bold  hover:text-yellow-200">
              L
            </span>
            <span className="font-light hover:font-bold  hover:text-yellow-200">
              u
            </span>
            <span className="font-bold text-lg text-emerald-500  hover:text-yellow-200">
              xo
            </span>
            <span className="font-light hover:font-bold  hover:text-yellow-200">
              ra
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                <span
                  className="absolute -top-2 -left-1 bg-emerald-500 text-white rounded-full px-1.5
